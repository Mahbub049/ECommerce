                ...
                <div class="control-group">
                    ...
                    <div class="control">
                        <select name="size" style="margin-left: 20px;">
                            ...
                            <option style="color: black !important" value="{{$size->id}}">  {{implode(',',Json_decode($size->size))}} </option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="control">
                        <select name="color" style="margin-left: 20px;">
                            ...
                            <option style="color: black !important" value="{{$color->id}}">  {{implode(',',Json_decode($color->color))}} </option>
                            {{-- <option style="color: black !important" value="{{$color->id}}"> {{$color->color}} </option> --}}
                            @endforeach
                        </select>
                    </div>
                </div>
